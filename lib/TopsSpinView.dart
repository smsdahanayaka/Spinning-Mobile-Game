...
class TopSpinView extends StatefulWidget {
  ...
  @override
  State<TopSpinView> createState() => _SpiningWheelState();
}

class _SpiningWheelState extends State<TopSpinView> {

  var arrayList=[" Essential Crew Neck Tee","ATHLEISURE","ESSENTIALS V NECK TEE","ATHLEISURE","Essential Tank Top","ENERGIZE TANK","Essential Crop Top Tee",];
  late String resultPrint;
  late Timer timer;
  late Random random;
  late String result;
                          ...
                          child: Align(
                            ...
                            child: Transform.rotate(
                              ...
                              child: Image(
                                ...
                                image: AssetImage('assets/images/3.2.png'),
                              ),
                            ),
                          ),
                        ),
